...
const Layout = () => {
    ...
    return (
        <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden">
            {/* Top Navigation */}
            <header className="sticky top-0 z-50 w-full bg-surface-light/95 dark:bg-surface-dark/95 backdrop-blur-md border-b border-slate-200 dark:border-slate-800">
                <div className="px-4 md:px-10 py-3 mx-auto max-w-7xl flex items-center justify-between whitespace-nowrap">
                    <Link to="/" className="flex items-center gap-3 text-text-main dark:text-white">
                        ...
                        <h2 className="text-lg font-bold leading-tight tracking-[-0.015em]">Concierge Care</h2>
                    </Link>
                ...
                {/* Mobile Menu */}
                {isMenuOpen && (
                    <div className="lg:hidden absolute top-full left-0 w-full bg-surface-light dark:bg-surface-dark border-b border-slate-200 dark:border-slate-800 py-4 px-4 flex flex-col gap-2 shadow-xl">
            ...
            <footer className="bg-surface-dark text-slate-400 py-12 border-t border-slate-800">
                <div className="mx-auto max-w-7xl px-4 md:px-10">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                        <div className="col-span-1 md:col-span-2">
                            <div className="flex items-center gap-2 text-white mb-4">
                                <span className="material-symbols-outlined text-primary">medical_services</span>
                                <span className="font-bold text-xl">Concierge Care</span>
                            </div>
                            <p className="text-sm max-w-xs mb-6">
                                {t('footerDesc')}
                            </p>
                            <div className="flex gap-4">
                                <a className="text-slate-400 hover:text-white transition-colors" href="#" aria-label="Social"><span className="material-symbols-outlined">social_leaderboard</span></a>
                                <a className="text-slate-400 hover:text-white transition-colors" href="#" aria-label="Video"><span className="material-symbols-outlined">smart_display</span></a>
                                <a className="text-slate-400 hover:text-white transition-colors" href="#" aria-label="Photo"><span className="material-symbols-outlined">photo_camera</span></a>
                            </div>
                        </div>
                        <div>
